...
def load_and_register_table(glue_context, table_config, year=None, month=None, day=None):
...
def main():
    ...
    try:
        ...
        year, month, day = get_partition_date(args)
        for table_key, table_config in TABLE_CONFIG.items():
            load_and_register_table(glueContext, table_config, year, month, day)
